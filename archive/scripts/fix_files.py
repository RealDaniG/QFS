...
files = {
    "v13/__init__.py": "# v13 package\n",
    "v13/ledger/__init__.py": "# v13.ledger package\n",
    "v13/ledger/genesis_ledger.py": r'''import json
import os
import hashlib
import asyncio
...
class GenesisEntry(BaseModel):
    ...
    def __init__(self, **data):
        ...
        if not self.timestamp:
            self.timestamp = det_time_isoformat() + "Z"
