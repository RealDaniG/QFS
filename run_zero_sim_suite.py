...
TEST_SUITES = [
    {
        ...
        "command": [sys.executable, "-m", "pytest", "v13/tests/deterministic/test_value_node_replay_determinism.py", "-v"],
        "critical": True
    },
    {
        "name": "Humor Slice Zero-Sim",
        "command": [sys.executable, "-m", "pytest", "v13/tests/test_humor_deterministic_replay.py", "-v"],
        "critical": True
    },
    {
        "name": "Value-Node Replay & Explainability",
        "command": [sys.executable, "-m", "pytest", "v13/tests/unit/test_value_node_replay_explanation.py", "-v"],
        "critical": True
    },
    {
    ...
    for suite in TEST_SUITES:
        ...
        try:
            ...
            suite_result = {
                ...
                "output_tail": result.stdout[-500:] if result.stdout else result.stderr[-500:]
            }
