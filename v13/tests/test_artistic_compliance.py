...
POLICY_FILES = [
    "v13/policy/artistic_policy.py",
    "v13/policy/artistic_observatory.py"
]
...
def test_no_float_comparisons_without_tolerance():
    ...
    # This is a weak check but helps catch obvious bad practices
    # We skip strictly for now as AST analysis for this is complex
    pass
