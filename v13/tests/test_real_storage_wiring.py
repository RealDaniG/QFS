...
class FakeStorageClient:
    ...
    def get_content_metadata(self, content_id):
        ...
        return {
            "author_did": f"did:user:test_user",
            "community_id": "test_community",
            "tags": ["tag1", "tag2"],
            "engagement_signals": {
                "likes": BigNum128.from_int(100),
                "comments": BigNum128.from_int(50),
                "shares": BigNum128.from_int(25)
            },
            "content_cid": f"Qm{hash(content_id):040d}",
...
class TestRealStorageWiring:
    ...
    def test_storage_ipfs_wiring(self):
        ...
        # Test with mock content (default behavior)
        ...
        assert fake_storage.get_metadata_count == 3  # 3 content items
        assert fake_ipfs.get_content_count == 3  # 3 content items
    ...
    def test_storage_ipfs_fallback(self):
        ...
        # Create fake clients that always fail
