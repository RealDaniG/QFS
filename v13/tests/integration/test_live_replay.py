...
def mock_ledger_artifact(tmp_path):
    ...
    entries = [
        ...
        },
        {
            ...
            "data": {"rewards": {"wallet_123": {"amount": "100.0"}}},
...
def test_live_replay_hydration(mock_ledger_artifact):
    ...
    # Initialize with the mock artifact
