...
class TestStorageEngineAEGISIntegration:
    ...
    def setup_method(self):
        ...
        self.cm = CertifiedMath()
        self.storage_engine = StorageEngine(self.cm)
        self.registry_snapshot = {'schema_version': 'v1.0', 'nodes': {'node_valid': {'pqc_public_key': '0x1234567890abcdef', 'pqc_scheme': 'Dilithium5', 'revoked': False}, 'node_revoked': {'pqc_public_key': '0xabcdef123456', 'pqc_scheme': 'Dilithium5', 'revoked': True, 'revocation_reason': 'Security violation'}}}
        self.telemetry_snapshot = {'schema_version': 'v1.0', 'telemetry_hash': 'a' * 64, 'block_height': 12345, 'nodes': {'node_valid': {'uptime_ratio': '0.95', 'health_score': '0.80', 'conflict_detected': False}, 'node_revoked': {'uptime_ratio': '0.95', 'health_score': '0.80', 'conflict_detected': False}}}
