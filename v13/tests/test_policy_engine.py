...
class TestPolicyEngine:
    ...
    def test_custom_configuration_less_strict_warnings(self):
        ...
        custom_config = PolicyConfiguration(
            warning_visibility=VisibilityLevel.VISIBLE,  # Warnings remain visible
        ...
        # Verify policy hints with custom configuration
        assert hints.visibility_level == VisibilityLevel.VISIBLE  # Custom setting
        assert hints.warning_banner == WarningBannerType.SAFETY  # Custom setting
        assert hints.requires_click_through is False  # Custom setting
        assert "aegis_severity_warning" in hints.client_tags
        assert "aegis_block_suggested" in hints.client_tags
    ...
    def test_deterministic_behavior(self):
        ...
        # Generate hints twice with same input
