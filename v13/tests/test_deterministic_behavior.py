...
def run_deterministic_test(test_name, run_number):
    ...
    results = {
        ...
        "interaction_response": {
            ...
            "safety_guard_passed": interaction_response.guard_results.safety_guard_passed if interaction_response.guard_results else False,
            "economics_guard_passed": interaction_response.guard_results.economics_guard_passed if interaction_response.guard_results else False
        }
    }
