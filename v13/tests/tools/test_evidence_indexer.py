...
# Add the tools directory to the path so we can import the indexer
import sys
import os
...
class TestEvidenceIndexer:
    ...
    def setup_method(self):
        ...
        # Create some test evidence files
    ...
    def _create_test_evidence_files(self):
        ...
        # Create phase1 directory with files
    ...
    def test_scan_evidence_directories(self):
        ...
        # Should find 4 artifacts (2 in phase1, 2 in storage)
    ...
    def test_process_artifact(self):
        ...
        # Component and phase detection may vary, just check they exist
