...
class TestPQCAdapterMock:
    ...
    def test_sign_verify_round_trip(self):
        ...
        try:
            # Generate keys
            seed = b"sign_roundtrip_seed_123456789012345"  # 32 bytes
    ...
    def test_tamper_detection(self):
        ...
        try:
            # Generate keys
            seed = b"tamper_detect_seed_1234567890123456"  # 32 bytes
            private_key, public_key = self.adapter.keygen(seed)
    ...
    def test_wrong_key_detection(self):
        ...
        try:
            ...
            seed1 = b"wrong_key_seed_1_12345678901234567"  # 32 bytes
            seed2 = b"wrong_key_seed_2_12345678901234567"  # 32 bytes
    ...
    def test_tampered_signature_detection(self):
        ...
        try:
            # Generate keypair
            seed = b"tamper_sig_seed_123456789012345678"  # 32 bytes
            private_key, public_key = self.adapter.keygen(seed)
            ...
            tampered_signature[0] ^= 0xFF  # Flip all bits in first byte
    ...
    def test_empty_message_handling(self):
        ...
        try:
            # Generate keypair
            seed = b"empty_msg_seed_1234567890123456789"  # 32 bytes
            private_key, public_key = self.adapter.keygen(seed)
    ...
    def test_large_message_handling(self):
        ...
        try:
            # Generate keypair
            seed = b"large_msg_seed_123456789012345678"  # 32 bytes
            private_key, public_key = self.adapter.keygen(seed)
