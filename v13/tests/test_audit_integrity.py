...
def test_integrity_verification_success():
    ...
    # Hash of {"action":"TEST","actor":"Alice","ts":123} with separators (',', ':')
    # Use the function logic to get expected hash first for test correctness
    import json, hashlib
...
def test_tamper_detection_chain():
    ...
    # 2. Broken Chain (prev_hash mismatch)
    ...
    # 3. Tampered Content (content changed without updating hash)
