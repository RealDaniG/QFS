...
"""
import pytest
from v13.services.notification_service import NotificationService, Notification, NotificationCategory
...
class TestNotificationService:
    ...
    def test_process_ledger_entry_creates_notification(self):
        ...
        token_state_entry = MockLedgerEntry(entry_id='token_state_001', timestamp=1234567890, entry_type='token_state', data={'test': 'data'})
    ...
    def test_get_notifications_by_category(self):
        ...
        class MockLedgerEntry:
            ...
            def __init__(self, entry_id, timestamp, entry_type, data):
                ...
                self.entry_hash = 'test_hash_' + entry_id
        token_state_entry = MockLedgerEntry(entry_id='token_state_001', timestamp=1234567890, entry_type='token_state', data={'test': 'data'})
        reward_allocation_entry = MockLedgerEntry(entry_id='reward_alloc_001', timestamp=1234567891, entry_type='reward_allocation', data={'test': 'data'})
