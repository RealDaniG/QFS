...
class TestAEGISGuard:
    ...
    def test_observe_event_creates_observation(self):
        ...
        cm = CertifiedMath()
        aegis_guard = AEGISGuard(cm)
        token_bundle = create_token_state_bundle(chr_state={'coherence_metric': '0.98', 'c_holo_proxy': '0.99'}, flx_state={'flux_metric': '0.15'}, psi_sync_state={'psi_sync_metric': '0.08'}, atr_state={'atr_metric': '0.85'}, res_state={'resonance_metric': '0.05'}, nod_state={'nod_metric': '0.5'}, lambda1=BigNum128(1618033988749894848), lambda2=BigNum128(618033988749894848), c_crit=BigNum128.from_int(1), pqc_cid='test_pqc_cid', timestamp=1234567890)
        inputs = {'user_id': 'test_user', 'event_type': 'feed_ranking', 'score': '0.95'}
        observation = aegis_guard.observe_event(event_type='feed_ranking', inputs=inputs, token_bundle=token_bundle, deterministic_timestamp=1234567890)
    ...
    def test_multiple_observations(self):
        ...
        aegis_guard = AEGISGuard(cm)
        token_bundle = create_token_state_bundle(chr_state={'coherence_metric': '0.98', 'c_holo_proxy': '0.99'}, flx_state={'flux_metric': '0.15'}, psi_sync_state={'psi_sync_metric': '0.08'}, atr_state={'atr_metric': '0.85'}, res_state={'resonance_metric': '0.05'}, nod_state={'nod_metric': '0.5'}, lambda1=BigNum128(1618033988749894848), lambda2=BigNum128(618033988749894848), c_crit=BigNum128.from_int(1), pqc_cid='test_pqc_cid', timestamp=1234567890)
        observation1 = aegis_guard.observe_event(event_type='feed_ranking', inputs={'event': '1'}, token_bundle=token_bundle, deterministic_timestamp=1234567890)
        observation2 = aegis_guard.observe_event(event_type='social_interaction', inputs={'event': '2'}, token_bundle=token_bundle, deterministic_timestamp=1234567891)
    ...
    def test_deterministic_observations(self):
        ...
        token_bundle = create_token_state_bundle(chr_state={'coherence_metric': '0.98', 'c_holo_proxy': '0.99'}, flx_state={'flux_metric': '0.15'}, psi_sync_state={'psi_sync_metric': '0.08'}, atr_state={'atr_metric': '0.85'}, res_state={'resonance_metric': '0.05'}, nod_state={'nod_metric': '0.5'}, lambda1=BigNum128(1618033988749894848), lambda2=BigNum128(618033988749894848), c_crit=BigNum128.from_int(1), pqc_cid='test_pqc_cid', timestamp=1234567890)
        inputs = {'user_id': 'test_user', 'event_type': 'test_event', 'data': 'test_data'}
        obs1 = guard1.observe_event(event_type='test_event', inputs=inputs, token_bundle=token_bundle, deterministic_timestamp=1234567890)
        obs2 = guard2.observe_event(event_type='test_event', inputs=inputs, token_bundle=token_bundle, deterministic_timestamp=1234567890)
