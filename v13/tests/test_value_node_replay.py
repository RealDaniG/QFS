...
def sample_events():
    return [
        ...
        {"type": "InteractionCreated", "user_id": "u2", "content_id": "c1", "interaction_type": "like", "weight": 1.0, "timestamp": 1050},
        {"type": "InteractionCreated", "user_id": "u3", "content_id": "c1", "interaction_type": "share", "weight": 2.0, "timestamp": 1060},
        {"type": "RewardAllocated", "user_id": "u1", "amount_atr": 10, "timestamp": 1100}
    ]
...
def test_explain_ranking_from_replay(replay_engine, sample_events):
    ...
    # Interaction Volume: 2 interactions / 10 = 0.2
    # Signals checking
