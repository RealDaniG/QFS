...
class TestPolicyIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_candidates = [{'content_id': 'post_1', 'content_cid': 'cid_1', 'author_id': 'user_1', 'text': 'Test post 1'}, {'content_id': 'post_2', 'content_cid': 'cid_2', 'author_id': 'user_2', 'text': 'Test post 2'}]
        ...
        self.gateway._build_coherence_input = Mock(return_value={'content_id': 'test_content', 'features': ['feature1', 'feature2']})
