...
class CertifiedMathTest:
    ...
    def test_basic_arithmetic(self):
        ...
        if abs(result.value - expected.value) < BigNum128.SCALE // 1000000000000:
            ...
            self.failed += 1
            self.test_results.append({'test': 'basic_arithmetic_addition', 'status': 'FAILED', 'expected': expected.to_decimal_string(), 'actual': result.to_decimal_string()})
        ...
        if abs(result.value - expected.value) < BigNum128.SCALE // 1000000000000:
            ...
            self.failed += 1
            self.test_results.append({'test': 'basic_arithmetic_subtraction', 'status': 'FAILED', 'expected': expected.to_decimal_string(), 'actual': result.to_decimal_string()})
        ...
        if abs(result.value - expected.value) < BigNum128.SCALE // 1000000000000:
            ...
            self.failed += 1
            self.test_results.append({'test': 'basic_arithmetic_multiplication', 'status': 'FAILED', 'expected': expected.to_decimal_string(), 'actual': result.to_decimal_string()})
        ...
        if abs(result.value - expected.value) < BigNum128.SCALE // 1000000000000:
            ...
            self.failed += 1
            self.test_results.append({'test': 'basic_arithmetic_division', 'status': 'FAILED', 'expected': expected.to_decimal_string(), 'actual': result.to_decimal_string()})
    ...
    def generate_report(self):
        ...
        report = {'timestamp': datetime.utcnow().isoformat() + 'Z', 'tests_run': self.passed + self.failed, 'tests_passed': self.passed, 'tests_failed': self.failed, 'results': self.test_results}
