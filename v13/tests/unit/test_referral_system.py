...
class TestReferralSystem:
    ...
    def test_referral_cap(self):
        ...
        mock_ledger = Mock()
        ref_ledger = ReferralLedger(mock_ledger)
        ref_ledger._count_referrals = Mock(return_value=100)
    ...
    def test_referral_activation(self):
        ...
        assert reward_arg.amount_scaled == 10000000000
    ...
    def test_referral_tiers(self):
        ...
        def check_tier(referral_count, expected_reward):
            ...
            ref_ledger._get_pending_referral = Mock(
                return_value={"referrer": "0xRef", "code": "c"}
            )
        ...
        check_tier(0, 10000000000)
        check_tier(5, 8000000000)
        check_tier(20, 5000000000)

    def test_referral_link_creation_below_cap(self):
        """Explicit test for success path below cap."""
        mock_ledger = Mock()
        ref_ledger = ReferralLedger(mock_ledger)
        ref_ledger._count_referrals = Mock(return_value=99)
