...
def test_replay_dm_events():
    ...
    events = [{'event_type': 'DM_THREAD_CREATED', 'thread_id': 't1', 'participants': ['u1', 'u2']}, {'event_type': 'DM_MESSAGE_SENT', 'thread_id': 't1', 'sender': 'u1', 'message_id': 'm1'}, {'event_type': 'DM_MESSAGE_SENT', 'thread_id': 't1', 'sender': 'u2', 'message_id': 'm2'}]
