...
EPSILON_EXPONENTIAL = BigNum128.from_string('0.000000001')
EPSILON_TRIGONOMETRIC = BigNum128.from_string('0.000000001')
EPSILON_HYPERBOLIC = BigNum128.from_string('0.000000001')
EPSILON_ERF = BigNum128.from_string('0.000001')
...
class TestExponentialProofVectors:
    ...
    def test_exp_proofvector_0(self):
        ...
        assert error <= EPSILON_EXPONENTIAL.value, f'exp(0) failed: got {result}, expected {expected}, error {error}'
    ...
    def test_exp_proofvector_1(self):
        ...
        result = math_engine.exp(input_val)
        error = abs(result.value - expected.value)
        assert error <= EPSILON_EXPONENTIAL.value, f'exp(1) failed: got {result}, expected {expected}, error {error}'
    ...
    def test_exp_proofvector_2(self):
        ...
        result = math_engine.exp(input_val)
        error = abs(result.value - expected.value)
        assert error <= EPSILON_EXPONENTIAL.value, f'exp(2) failed: got {result}, expected {expected}, error {error}'
    ...
    def test_exp_proofvector_half(self):
        ...
        result = math_engine.exp(input_val)
        error = abs(result.value - expected.value)
        assert error <= EPSILON_EXPONENTIAL.value, f'exp(0.5) failed: got {result}, expected {expected}, error {error}'
...
class TestLogarithmProofVectors:
    ...
    def test_ln_proofvector_1(self):
        ...
        error = abs(result.value - expected.value)
        assert error <= EPSILON_EXPONENTIAL.value, f'ln(1) failed: got {result}, expected {expected}, error {error}'
    ...
    def test_ln_proofvector_e(self):
        ...
        result = math_engine.ln(input_val)
        error = abs(result.value - expected.value)
        assert error <= EPSILON_EXPONENTIAL.value, f'ln(e) failed: got {result}, expected {expected}, error {error}'
    ...
    def test_ln_proofvector_2(self):
        ...
        result = math_engine.ln(input_val)
        error = abs(result.value - expected.value)
        assert error <= EPSILON_EXPONENTIAL.value, f'ln(2) failed: got {result}, expected {expected}, error {error}'
    ...
    def test_ln_proofvector_10(self):
        ...
        result = math_engine.ln(input_val)
        error = abs(result.value - expected.value)
        assert error <= EPSILON_EXPONENTIAL.value, f'ln(10) failed: got {result}, expected {expected}, error {error}'
...
class TestSineProofVectors:
    ...
    def test_sin_proofvector_0(self):
        ...
        error = abs(result.value - expected.value)
        assert error <= EPSILON_TRIGONOMETRIC.value, f'sin(0) failed: got {result}, expected {expected}, error {error}'

    def test_sin_proofvector_pi_over_6(self):
        """ProofVector: sin(π/6) ≈ 0.5"""
        math_engine = CertifiedMath()
        input_val = BigNum128.from_string('0.523598776')
        expected = BigNum128.from_string('0.5')
        result = math_engine.sin(input_val)
        error = abs(result.value - expected.value)
        assert error <= EPSILON_TRIGONOMETRIC.value, f'sin(π/6) failed: got {result}, expected {expected}, error {error}'
    ...
    def test_sin_proofvector_1(self):
        ...
        result = math_engine.sin(input_val)
        error = abs(result.value - expected.value)
        assert error <= EPSILON_TRIGONOMETRIC.value, f'sin(1) failed: got {result}, expected {expected}, error {error}'
...
class TestCosineProofVectors:
    ...
    def test_cos_proofvector_0(self):
        ...
        error = abs(result.value - expected.value)
        assert error <= EPSILON_TRIGONOMETRIC.value, f'cos(0) failed: got {result}, expected {expected}, error {error}'

    def test_cos_proofvector_pi_over_3(self):
        """ProofVector: cos(π/3) ≈ 0.5"""
        math_engine = CertifiedMath()
        input_val = BigNum128.from_string('1.047197551')
        expected = BigNum128.from_string('0.5')
        result = math_engine.cos(input_val)
        error = abs(result.value - expected.value)
        assert error <= EPSILON_TRIGONOMETRIC.value, f'cos(π/3) failed: got {result}, expected {expected}, error {error}'
    ...
    def test_cos_proofvector_1(self):
        ...
        result = math_engine.cos(input_val)
        error = abs(result.value - expected.value)
        assert error <= EPSILON_TRIGONOMETRIC.value, f'cos(1) failed: got {result}, expected {expected}, error {error}'
...
class TestTanhProofVectors:
    ...
    def test_tanh_proofvector_0(self):
        ...
        error = abs(result.value - expected.value)
        assert error <= EPSILON_HYPERBOLIC.value, f'tanh(0) failed: got {result}, expected {expected}, error {error}'
    ...
    def test_tanh_proofvector_1(self):
        ...
        result = math_engine.tanh(input_val)
        error = abs(result.value - expected.value)
        assert error <= EPSILON_HYPERBOLIC.value, f'tanh(1) failed: got {result}, expected {expected}, error {error}'
    ...
    def test_tanh_proofvector_half(self):
        ...
        result = math_engine.tanh(input_val)
        error = abs(result.value - expected.value)
        assert error <= EPSILON_HYPERBOLIC.value, f'tanh(0.5) failed: got {result}, expected {expected}, error {error}'
...
class TestSigmoidProofVectors:
    ...
    def test_sigmoid_proofvector_0(self):
        ...
        error = abs(result.value - expected.value)
        assert error <= EPSILON_HYPERBOLIC.value, f'sigmoid(0) failed: got {result}, expected {expected}, error {error}'
    ...
    def test_sigmoid_proofvector_1(self):
        ...
        result = math_engine.sigmoid(input_val)
        error = abs(result.value - expected.value)
        assert error <= EPSILON_HYPERBOLIC.value, f'sigmoid(1) failed: got {result}, expected {expected}, error {error}'
    ...
    def test_sigmoid_proofvector_2(self):
        ...
        result = math_engine.sigmoid(input_val)
        error = abs(result.value - expected.value)
        assert error <= EPSILON_HYPERBOLIC.value, f'sigmoid(2) failed: got {result}, expected {expected}, error {error}'
...
class TestErfProofVectors:
    ...
    def test_erf_proofvector_0(self):
        ...
        error = abs(result.value - expected.value)
        assert error <= EPSILON_ERF.value, f'erf(0) failed: got {result}, expected {expected}, error {error}'
    ...
    def test_erf_proofvector_half(self):
        ...
        result = math_engine.erf(input_val)
        error = abs(result.value - expected.value)
        assert error <= EPSILON_ERF.value, f'erf(0.5) failed: got {result}, expected {expected}, error {error}'
    ...
    def test_erf_proofvector_1(self):
        ...
        result = math_engine.erf(input_val)
        error = abs(result.value - expected.value)
        assert error <= EPSILON_ERF.value, f'erf(1) failed: got {result}, expected {expected}, error {error}'
...
class TestDeterminismValidation:
    ...
    def test_exp_determinism(self):
        ...
        assert all((r.value == results[0].value for r in results)), 'exp(1) produced non-deterministic results'
    ...
    def test_ln_determinism(self):
        ...
        assert all((r.value == results[0].value for r in results)), 'ln(2) produced non-deterministic results'
    ...
    def test_sin_determinism(self):
        ...
        assert all((r.value == results[0].value for r in results)), 'sin(1) produced non-deterministic results'
