...
def test_determinism():
    ...
    packet1 = DRV_Packet(
        ttsTimestamp=1700000000, sequence=1, seed="test_seed", metadata={"test": "data"}
    )
    ...
    test_data = {
        "certifiedmath": result1,
        "pqc_pubkey": pubkey1[:32] + "...",
        "drv_packet_hash": hash1[:32] + "...",
        "bundle_hash": bundle_hash1[:32] + "...",
    }
