...
try:
    from v13.core.DRV_Packet import (
        DRV_Packet,
        ValidationResult,
        ValidationErrorCode,
        clear_drv_packet_audit_log,
        get_drv_packet_audit_log,
        get_drv_packet_audit_hash,
    )
except ImportError:
    from v13.core import DRV_Packet
