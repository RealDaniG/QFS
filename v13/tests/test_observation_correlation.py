...
class TestObservationCorrelation:
    ...
    def test_correlate_agi_with_aegis_observations(self):
        ...
        # First, submit an interaction to generate AEGIS observations
        interaction_result = self.router.route_post_interaction(
            interaction_type="comment",
            user_id="test_user",
            target_id="test_post",
            content="This is a test comment with potential issues"
        )
        ...
        # Submit an AGI observation that references the AEGIS observation
        ...
        # Verify AGI observation was accepted
        ...
        # Check that we have both AEGIS and AGI observations
        ...
        # Verify the AGI observation has the correlated AEGIS events
    ...
    def test_correlation_with_content_id(self):
        ...
        # Submit an AGI observation with content reference
        agi_result = self.router.route_submit_agi_observation(
            role=OPENAGIRole.SYSTEM.value,
            action_type=OPENAGIActionType.READ_STATE.value,
            inputs={
        ...
        # Get correlated observations by content ID
        correlation_result = self.router.route_get_correlated_observations(
