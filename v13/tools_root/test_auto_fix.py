"""
Test auto-fix script for QFS V13 AST violations on a specific file
"""
import ast
import pathlib
import sys
...
def main():
    # Test on our specific test file
    test_file = ROOT / "test_violations.py"
    if test_file.exists():
        print(f"[INFO] Testing on {test_file}")
        transform_file(test_file, dry_run=False)  # Actually apply changes
    else:
