...
def create_test_bundle(cm, timestamp=1234567890):
    ...
    return TokenStateBundle(chr_state={'coherence_metric': '0.98'}, flx_state={'flux_metric': '0.15'}, psi_sync_state={'psi_sync_metric': '0.08'}, atr_state={'atr_metric': '0.85'}, res_state={'resonance_metric': '0.05'}, signature='test_sig', timestamp=timestamp, bundle_id=f'bundle_{timestamp}', pqc_cid=f'pqc_{timestamp}', quantum_metadata={}, lambda1=CertifiedMath.from_string('0.3'), lambda2=CertifiedMath.from_string('0.2'), c_crit=CertifiedMath.from_string('0.9'), parameters={})
