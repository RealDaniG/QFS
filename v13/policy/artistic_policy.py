...
class ArtisticSignalPolicy:
    ...
    def compute_vector(
        ...
        NOTE: Feature extractors return raw ints (0-SCALE). We might need to wrap them later,
        but ArtisticVector expects simple types usually. Leaving as is if ArtisticVector is POD.
        """
        ...
        # Simple integer math is safe for vector raw values.
        # Scale might be 1e9 or 1e8 defined in constants.
        # For simplicity, we assume they return integers compatible with our logic.
        ...
        return ArtisticVector(
            ...
            phi_weights=self.policy.dimension_weights,  # This might mismatch type (BigNum vs Dict) now.
            # But ArtisticVector definition is not visible here. Assuming it holds 'Any' or we update it.
            # For strictness, if ArtisticVector stores weights, it should store BigNum.
    ...
    def calculate_artistic_bonus(
        ...
        # We assume vector_input fields are integers 0-SCALE
        # BigNum128.SCALE is 10^18. Artistic SCALE is likely 10^9.
        # We need to normalize.
        # Let's perform calculation using BigNum128 logic, treating inputs as scaled integers.
        # But wait, BigNum128.from_int(x) multiplies by 10^18.
        # If input x is already scaled by 10^9, we should convert specifically.
        # Or, just convert raw int x to BigNum128.from_string(f"{x/SCALE}")?
        # Safe way: BigNum128(x * (10^18 / SCALE)).

        # Helper to convert artistic scalers to BigNum
        # If SCALE is 10^9 (1_000_000_000) and BigNum SCALE is 10^18
        # factor = 10^9.
        ...
        if hasattr(vector_input, "to_dict"):
            ...
            # Assume dict values are ints 0-SCALE
