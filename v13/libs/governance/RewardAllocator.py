...
try:
    ...
    from ...libs.economics.economic_constants import MAX_REWARD_PER_ADDRESS, MIN_DUST_THRESHOLD
except ImportError:
    try:
        ...
        from v13.libs.economics.economic_constants import MAX_REWARD_PER_ADDRESS, MIN_DUST_THRESHOLD
    except ImportError:
        try:
            from v13.libs.CertifiedMath import CertifiedMath, BigNum128
            from v13.core.reward_types import RewardBundle
            ...
            from economics.economic_constants import MAX_REWARD_PER_ADDRESS, MIN_DUST_THRESHOLD
...
class RewardAllocator:
    ...
    def allocate_rewards(self, reward_bundle: RewardBundle, recipient_addresses: List[str], log_list: List[Dict[str, Any]], allocation_weights: Optional[Dict[str, BigNum128]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None, deterministic_timestamp: int=0) -> Dict[str, AllocatedReward]:
        """
        ...
        for address in recipient_addresses:
            ...
            total_amount = self.cm.add(self.cm.add(chr_amount, flx_amount, log_list, pqc_cid, quantum_metadata), self.cm.add(self.cm.add(res_amount, psi_sync_amount, log_list, pqc_cid, quantum_metadata), atr_amount, log_list, pqc_cid, quantum_metadata), log_list, pqc_cid, quantum_metadata)
            addr_validation = self.economics_guard.validate_per_address_reward(address=address, chr_amount=chr_amount, flx_amount=flx_amount, res_amount=res_amount, total_amount=total_amount, log_list=log_list)
            if not addr_validation.passed:
                log_list.append({'operation': 'reward_allocation_per_address_violation', 'address': address, 'error_code': addr_validation.error_code, 'error_message': addr_validation.error_message, 'details': addr_validation.details, 'timestamp': deterministic_timestamp})
            ...
            if is_dust:
                log_list.append({'operation': 'reward_allocation_dust_detected', 'address': address, 'total_amount': total_amount.to_decimal_string(), 'dust_threshold': MIN_DUST_THRESHOLD.to_decimal_string(), 'policy': 'allocate_with_warning', 'timestamp': deterministic_timestamp})
            allocated_rewards[address] = AllocatedReward(address=address, chr_amount=chr_amount, flx_amount=flx_amount, res_amount=res_amount, psi_sync_amount=psi_sync_amount, atr_amount=atr_amount, total_amount=total_amount)
        self._log_reward_allocation(reward_bundle, recipient_addresses, allocation_weights, allocated_rewards, log_list, pqc_cid, quantum_metadata, deterministic_timestamp)
        return allocated_rewards

    def _create_equal_weights(self, recipient_addresses: List[str], log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> Dict[str, BigNum128]:
        """
    ...
    def _normalize_weights(self, allocation_weights: Dict[str, BigNum128], log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> Dict[str, BigNum128]:
        """
    ...
    def _log_reward_allocation(self, reward_bundle: RewardBundle, recipient_addresses: List[str], allocation_weights: Dict[str, BigNum128], allocated_rewards: Dict[str, AllocatedReward], log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None, deterministic_timestamp: int=0):
        """
        ...
        """
        weights_log = {address: weight.to_decimal_string() for address, weight in allocation_weights.items()}
        allocations_log = {address: {'CHR': alloc.chr_amount.to_decimal_string(), 'FLX': alloc.flx_amount.to_decimal_string(), 'RES': alloc.res_amount.to_decimal_string(), 'PsiSync': alloc.psi_sync_amount.to_decimal_string(), 'ATR': alloc.atr_amount.to_decimal_string(), 'Total': alloc.total_amount.to_decimal_string()} for address, alloc in allocated_rewards.items()}
        details = {'operation': 'reward_allocation', 'total_rewards': {'CHR': reward_bundle.chr_reward.to_decimal_string(), 'FLX': reward_bundle.flx_reward.to_decimal_string(), 'RES': reward_bundle.res_reward.to_decimal_string(), 'PsiSync': reward_bundle.psi_sync_reward.to_decimal_string(), 'ATR': reward_bundle.atr_reward.to_decimal_string(), 'Total': reward_bundle.total_reward.to_decimal_string()}, 'recipients': recipient_addresses, 'allocation_weights': weights_log, 'allocations': allocations_log}
        self.cm._log_operation('reward_allocation', details, reward_bundle.total_reward, log_list, pqc_cid, quantum_metadata)
...
def test_reward_allocator():
    ...
    from v13.core.reward_types import RewardBundle
    reward_bundle = RewardBundle(chr_reward=BigNum128.from_int(100), flx_reward=BigNum128.from_int(50), res_reward=BigNum128.from_int(25), psi_sync_reward=BigNum128.from_int(20), atr_reward=BigNum128.from_int(15), total_reward=BigNum128.from_int(210))
