...
class EconomicAdversarySuite:
    ...
    """
    ADVERSARIES = {'EA-1': {'name': 'Coherence Spoof', 'description': 'Attempt to spoof coherence metrics with invalid state', 'expected_cir': 'CIR-302', 'expected_response': 'BLOCKED', 'attack_vector': 'state_manipulation', 'severity_weight': 1}, 'EA-2': {'name': 'ΨSync Desync', 'description': 'Attempt to desynchronize global ΨSync consensus', 'expected_cir': 'CIR-412', 'expected_response': 'BLOCKED', 'attack_vector': 'consensus_manipulation', 'severity_weight': 1}, 'EA-3': {'name': 'Treasury Siphon', 'description': 'Attempt to siphon treasury rewards through coordinated shard manipulation', 'expected_cir': 'CIR-511', 'expected_response': 'BLOCKED', 'attack_vector': 'reward_manipulation', 'severity_weight': Fraction(3, 2)}, 'EA-4': {'name': 'Resonance Overdrive', 'description': 'Attempt to generate excessive RES through ψ-field manipulation', 'expected_cir': 'CIR-511', 'expected_response': 'BLOCKED', 'attack_vector': 'resonance_manipulation', 'severity_weight': Fraction(6, 5)}, 'EA-5': {'name': 'CHR Inflation', 'description': 'Attempt to create new CHR tokens violating conservation law', 'expected_cir': 'CIR-302', 'expected_response': 'BLOCKED', 'attack_vector': 'token_creation', 'severity_weight': 2}, 'EA-6': {'name': 'FLX Negative Flow', 'description': "Attempt to create negative FLX flows violating Kirchhoff's law", 'expected_cir': 'CIR-302', 'expected_response': 'BLOCKED', 'attack_vector': 'flow_manipulation', 'severity_weight': Fraction(3, 2)}, 'EA-7': {'name': 'ψCurl Collapse', 'description': 'Attempt to create ψ-curl anomalies that collapse field stability', 'expected_cir': 'CIR-412', 'expected_response': 'BLOCKED', 'attack_vector': 'field_manipulation', 'severity_weight': Fraction(9, 5)}, 'EA-8': {'name': 'ΨSync Race', 'description': 'Attempt to create race conditions in ΨSync consensus between shards', 'expected_cir': 'CIR-412', 'expected_response': 'BLOCKED', 'attack_vector': 'timing_attack', 'severity_weight': Fraction(13, 10)}, 'EA-9': {'name': 'Harmonic Divergence', 'description': 'Attempt to cause economic state divergence across shards', 'expected_cir': 'CIR-302', 'expected_response': 'BLOCKED', 'attack_vector': 'state_divergence', 'severity_weight': Fraction(17, 10)}, 'EA-10': {'name': 'Cross-Shard Imbalance', 'description': 'Attempt to create severe token imbalances between shards', 'expected_cir': 'CIR-511', 'expected_response': 'BLOCKED', 'attack_vector': 'imbalance_attack', 'severity_weight': Fraction(7, 5)}, 'EA-11': {'name': 'Oracle Timing', 'description': 'Attempt to manipulate economic oracle timing for profit', 'expected_cir': 'CIR-302', 'expected_response': 'BLOCKED', 'attack_vector': 'timing_attack', 'severity_weight': Fraction(11, 10)}, 'EA-12': {'name': 'QPU Mismatch', 'description': 'Attempt to exploit QPU differences for consensus advantage', 'expected_cir': 'None', 'expected_response': 'DETERMINISTIC_FALLBACK', 'attack_vector': 'platform_divergence', 'severity_weight': Fraction(4, 5)}, 'EA-13': {'name': 'Reward Amplification', 'description': 'Attempt to amplify rewards beyond A_MAX bound', 'expected_cir': 'CIR-511', 'expected_response': 'BLOCKED', 'attack_vector': 'reward_manipulation', 'severity_weight': Fraction(8, 5)}, 'EA-14': {'name': 'CHR Imbalance', 'description': 'Attempt to create CHR allocation imbalances across shards', 'expected_cir': 'CIR-511', 'expected_response': 'BLOCKED', 'attack_vector': 'allocation_manipulation', 'severity_weight': Fraction(13, 10)}}
