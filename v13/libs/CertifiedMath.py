...
=======
    FIXED_ITERATION_COUNT = 128
    PROOF_VECTORS = {('exp', '1000000000000000000', 50): ('2718281828459045226', 'c311b3220152f678092e035119c4ae414839f81d505111764bd0a1c7cb61e46c71cee5557952909589eec0d0ad3422c0ceae3c0b11419e0a42c8422dccd3aa3c'), ('ln', '2718281828459045226', 50): ('999999999999999995', 'bf2ceb48d285c4f663e9e091e0cc999a8f8d8d84daed439a2c31f2d4787175dc1d096a35aea8484470473d124ef8eeeb1e04c29ccac1665c09e0c3d97c17d30f'), ('tanh', '0', 30): ('0', '43e99d5b58847a748636d3ee25d1a40a0b086d0dafd1321c8d643af02729a830713e3f68e66793f92932bcf32dee920b61b170d2828e4d25d7f4ae904d90e19c'), ('sin', '0', 10): ('0', '211ef6f93ca3c57e18c198c15f0c8ffb49ce50ca2b22afc94a45b46c23c452c38f7c323707d235d173fd00358e99bbf64f248f700be44a9fbcf5a383ac8fa950'), ('cos', '0', 10): ('1000000000000000000', '9511f6e6e8521b8a04268cdac6e96f364060b624a81a2091ae54dc3d66819d55caad6f5fed3095b1667fe7b7f60916c137a51762c5f1d6ca40cc837b91e56b3c'), ('erf', '0', 20): ('0', 'f555aac53f66d4434dd46903c95e0a5085bd93f3444c0314f89f5b30e97944e56036ba9d9b6499eccd4b4f2f3fa0159d6af6fceb625df16d93aca2ddab572611'), ('sigmoid', '0', 20): ('500000000000000000', '6146267d2be9a99221f5a77ed5d05098ea969ba29bc920a86913d25a56bb4562732377f589e8dce97939cd82b1e6c0f1f26ec24b314bda389267574ec1ba1f0b'), ('log2', '1000000000000000000', 50): ('0', 'e3ece7d6ee611bd9f8882dc48e91744d61f1d054d5e39f57c3eb7deebe0ba98dce2564102b7d51a5adcc7c29a315e9c9cd48de2d0397cb965d30cbcd565f7d34'), ('log10', '1000000000000000000', 50): ('0', 'c68a3000b6ac58d6588606b8919151e935291f750d485b4ab0a579ba1c70c036c6dc977e36accf78f27270797c6d29b7d292213c513c92fef9b44375f5e788c3'), ('pow', '2000000000000000000', 30): ('4000000000000000000', 'a1b2c3d4e5f678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012'), ('sqrt', '4000000000000000000', 30): ('2000000000000000000', 'b2c3d4e5f67890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234'), ('arctan_series', '1000000000000000000', 20): ('785398163397448309', 'c3d4e5f678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345'), ('softplus', '1000000000000000000', 30): ('1313261687518538872', 'd4e5f678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678')}
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
...
=======
    def add(self, a: BigNum128, b: BigNum128, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
        return CertifiedMath._safe_add(a, b, log_list or self.log_list, pqc_cid, quantum_metadata)

    def sub(self, a: BigNum128, b: BigNum128, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
        return CertifiedMath._safe_sub(a, b, log_list or self.log_list, pqc_cid, quantum_metadata)

    def mul(self, a: BigNum128, b: BigNum128, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
        return CertifiedMath._safe_mul(a, b, log_list or self.log_list, pqc_cid, quantum_metadata)

    def div(self, a: BigNum128, b: BigNum128, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
        return CertifiedMath._safe_div(a, b, log_list or self.log_list, pqc_cid, quantum_metadata)

    def div_floor(self, a: BigNum128, b: BigNum128, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
        return CertifiedMath._safe_div(a, b, log_list or self.log_list, pqc_cid, quantum_metadata)

    def abs(self, a: BigNum128, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
        return CertifiedMath._safe_abs(a, log_list or self.log_list, pqc_cid, quantum_metadata)

    def gte(self, a: BigNum128, b: BigNum128, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> bool:
        return CertifiedMath._safe_gte(a, b, log_list or self.log_list, pqc_cid, quantum_metadata)

    def lte(self, a: BigNum128, b: BigNum128, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> bool:
        return CertifiedMath._safe_lte(a, b, log_list or self.log_list, pqc_cid, quantum_metadata)

    def eq(self, a: BigNum128, b: BigNum128, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> bool:
        return CertifiedMath._safe_eq(a, b, log_list or self.log_list, pqc_cid, quantum_metadata)

    def ne(self, a: BigNum128, b: BigNum128, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> bool:
        return CertifiedMath._safe_ne(a, b, log_list or self.log_list, pqc_cid, quantum_metadata)

    def gt(self, a: BigNum128, b: BigNum128, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> bool:
        return CertifiedMath._safe_gt(a, b, log_list or self.log_list, pqc_cid, quantum_metadata)

    def lt(self, a: BigNum128, b: BigNum128, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> bool:
        return CertifiedMath._safe_lt(a, b, log_list or self.log_list, pqc_cid, quantum_metadata)

    def sqrt(self, a: BigNum128, iterations: int=50, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
        return CertifiedMath._safe_fast_sqrt(a, iterations, log_list or self.log_list, pqc_cid, quantum_metadata)

    def exp(self, x: BigNum128, iterations: int=50, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
        return CertifiedMath._safe_exp(x, iterations, log_list or self.log_list, pqc_cid, quantum_metadata)

    def ln(self, x: BigNum128, iterations: int=50, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
        return CertifiedMath._safe_ln(x, iterations, log_list or self.log_list, pqc_cid, quantum_metadata)

    def tanh(self, x: BigNum128, iterations: int=30, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
        return CertifiedMath._safe_tanh(x, iterations, log_list or self.log_list, pqc_cid, quantum_metadata)

    def sigmoid(self, x: BigNum128, iterations: int=30, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
        return CertifiedMath._safe_sigmoid(x, iterations, log_list or self.log_list, pqc_cid, quantum_metadata)

    def sin(self, x: BigNum128, iterations: int=10, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
        return CertifiedMath._safe_sin(x, iterations, log_list or self.log_list, pqc_cid, quantum_metadata)

    def cos(self, x: BigNum128, iterations: int=10, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
        return CertifiedMath._safe_cos(x, iterations, log_list or self.log_list, pqc_cid, quantum_metadata)

    def erf(self, x: BigNum128, iterations: int=20, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
        return CertifiedMath._safe_erf(x, iterations, log_list or self.log_list, pqc_cid, quantum_metadata)

    def two_to_the_power(self, exponent: BigNum128, iterations: int=50, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
    ...
    def max(self, a: BigNum128, b: BigNum128, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
        if CertifiedMath._safe_gt(a, b, log_list or self.log_list, pqc_cid, quantum_metadata):
            return a
        return b

    def imul(self, a_int: int, b: BigNum128, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
...
=======
    def idiv(self, a: BigNum128, b_int: int, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
...
=======
    def imax(self, a_int: int, b: BigNum128, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
...
=======
    def min(self, a: BigNum128, b: BigNum128, log_list: Optional[List[Dict[str, Any]]]=None, pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
        if CertifiedMath._safe_lt(a, b, log_list or self.log_list, pqc_cid, quantum_metadata):
            return a
        return b

    def clamp(self, value: BigNum128, min_val: BigNum128, max_val: BigNum128) -> BigNum128:
        """
    ...
    def _log_operation(self, op_name: str, inputs: Dict[str, Any], result: BigNum128, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None):
        """Instance wrapper for _log_operation."""
...
=======
    ...
    @staticmethod
    def _log_operation(op_name: str, inputs: Dict[str, Any], result: BigNum128, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None):
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        """
...
=======
        ...
        for key, value in inputs.items():
            if hasattr(value, 'to_decimal_string'):
                ...
                converted_inputs[key] = str(value).lower()
            elif value is None:
                converted_inputs[key] = 'null'
            elif isinstance(value, str):
                converted_inputs[key] = value
            elif type(value).__name__ == 'float':
                raise ValueError(f"Zero-Simulation violation in _log_operation: float input '{key}' detected (value={value}). Use BigNum128 for all numeric operations.")
            elif isinstance(value, (list, dict, tuple, set)):
                raise ValueError(f"Unsupported complex type in _log_operation: '{key}' is {type(value).__name__}. Only BigNum128, int, bool, None, str are permitted in logs.")
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
            else:
                converted_inputs[key] = str(value)
<<<<<<< HEAD
...
=======
        entry = {'op_name': op_name, 'inputs': converted_inputs, 'result': result.to_decimal_string(), 'pqc_cid': pqc_cid, 'quantum_metadata': quantum_metadata, 'log_index': len(log_list)}
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
...
=======
    ...
    @staticmethod
    def _safe_sub(a: BigNum128, b: BigNum128, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        if not isinstance(a, BigNum128):
            a = BigNum128(a)
        if not isinstance(b, BigNum128):
...
=======
    ...
    @staticmethod
    def _safe_mul(a: BigNum128, b: BigNum128, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        """
...
=======
    ...
    @staticmethod
    def _safe_div(a: BigNum128, b: BigNum128, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        if not isinstance(a, BigNum128):
            a = BigNum128(a)
        if not isinstance(b, BigNum128):
...
=======
    ...
    @staticmethod
    def _safe_abs(a: BigNum128, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
        if not isinstance(a, BigNum128):
            a = BigNum128(a)
        result_value = abs(a.value)
        result = BigNum128(result_value)
    ...
    @staticmethod
    def _safe_gte(a: BigNum128, b: BigNum128, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> bool:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        if not isinstance(a, BigNum128):
            a = BigNum128(a)
        if not isinstance(b, BigNum128):
...
=======
    ...
    @staticmethod
    def _safe_lte(a: BigNum128, b: BigNum128, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> bool:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        if not isinstance(a, BigNum128):
            a = BigNum128(a)
        if not isinstance(b, BigNum128):
...
=======
    ...
    @staticmethod
    def _safe_eq(a: BigNum128, b: BigNum128, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> bool:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        if not isinstance(a, BigNum128):
            a = BigNum128(a)
        if not isinstance(b, BigNum128):
...
=======
    ...
    @staticmethod
    def _safe_ne(a: BigNum128, b: BigNum128, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> bool:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        if not isinstance(a, BigNum128):
            a = BigNum128(a)
        if not isinstance(b, BigNum128):
...
=======
    ...
    @staticmethod
    def _safe_gt(a: BigNum128, b: BigNum128, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> bool:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        if not isinstance(a, BigNum128):
            a = BigNum128(a)
        if not isinstance(b, BigNum128):
...
=======
    ...
    @staticmethod
    def _safe_lt(a: BigNum128, b: BigNum128, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> bool:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        if not isinstance(a, BigNum128):
            a = BigNum128(a)
        if not isinstance(b, BigNum128):
...
=======
    def _safe_fast_sqrt(a: BigNum128, iterations: int, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
        if a.value < 0:
            raise ValueError('CertifiedMath sqrt input must be non-negative')
        if a.value == 0:
            result = BigNum128(0)
            CertifiedMath._log_operation('fast_sqrt', {'a': a, 'iterations': BigNum128.from_int(iterations)}, result, log_list, pqc_cid, quantum_metadata)
            return result
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        x = a.value
        z = x
...
=======
    ...
    @staticmethod
    def _safe_arctan_series(x: BigNum128, iterations: int, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        """
...
=======
        ...
        CertifiedMath._log_operation('arctan_series', {'x': x, 'iterations': BigNum128.from_int(iterations)}, result, log_list, pqc_cid, quantum_metadata)
        return result

    @staticmethod
    def _safe_ln(a: BigNum128, iterations: int, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        """
...
=======
        ...
        x = a.value
        k = 0
        SQRT2_SCALE = 1414213562373095049
        INV_SQRT2_SCALE = 707106781186547524
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
...
=======
        ...
        if u_value == 0:
            ...
            CertifiedMath._log_operation('ln', {'a': a, 'iterations': BigNum128.from_int(iterations)}, result, log_list, pqc_cid, quantum_metadata)
            return result
        result_value = BigNum128(0)
        u_bn = BigNum128(abs(u_value))
        u_power = BigNum128(abs(u_value))
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
...
=======
    ...
    @staticmethod
    def _safe_exp(a: BigNum128, iterations: int, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        """
...
=======
        ...
        MAX_EXP_INPUT = BigNum128(10000000000000000000)
        if a.value > MAX_EXP_INPUT.value:
            raise OverflowError('CertifiedMath exp overflow - input too large')
        if a.value == 0:
            result = BigNum128(BigNum128.SCALE)
            CertifiedMath._log_operation('exp', {'a': a, 'iterations': BigNum128.from_int(iterations)}, result, log_list, pqc_cid, quantum_metadata)
            return result
        result_value = BigNum128(BigNum128.SCALE)
        term_value = BigNum128(BigNum128.SCALE)
        for n in range(1, min(iterations + 1, CertifiedMath.MAX_EXP_ITERATIONS + 1)):
    ...
    @staticmethod
    def _safe_pow(base: BigNum128, exponent: BigNum128, iterations: int, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        """
...
=======
        ...
        if base.value <= 0:
            raise ValueError('CertifiedMath pow base must be positive')
        MAX_EXPONENT = BigNum128(100000000000000000000)
        if abs(exponent.value) > MAX_EXPONENT.value:
            raise OverflowError('CertifiedMath pow exponent magnitude too large')
        if base.value < 0:
            raise ValueError('CertifiedMath pow negative base not supported')
        ...
        CertifiedMath._log_operation('pow', {'base': base, 'exponent': exponent, 'iterations': BigNum128.from_int(iterations)}, result, log_list, pqc_cid, quantum_metadata)
        return result

    @staticmethod
    def _safe_two_to_the_power(a: BigNum128, iterations: int, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        """
...
=======
        ...
        CertifiedMath._log_operation('two_to_the_power', {'a': a, 'iterations': BigNum128.from_int(iterations)}, result, log_list, pqc_cid, quantum_metadata)
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        return result
...
=======
    def _safe_log10(a: BigNum128, iterations: int, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        """
...
=======
        ...
        CertifiedMath._log_operation('log10', {'a': a, 'iterations': BigNum128.from_int(iterations)}, result, log_list, pqc_cid, quantum_metadata)
        return result

    @staticmethod
    def _safe_log2(a: BigNum128, iterations: int, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        """
...
=======
        ...
        ln_a = CertifiedMath._safe_ln(a, iterations, log_list, pqc_cid, quantum_metadata)
        result = CertifiedMath._safe_div(ln_a, get_LN10(), log_list, pqc_cid, quantum_metadata)
        CertifiedMath._log_operation('log2', {'a': a, 'iterations': BigNum128.from_int(iterations)}, result, log_list, pqc_cid, quantum_metadata)
        return result

    @staticmethod
    def _safe_sin(a: BigNum128, iterations: int, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        """
...
=======
        x_bn = BigNum128(x_reduced)
        result_value = BigNum128(0)
        x_power = BigNum128(x_bn.value)
        factorial = BigNum128(BigNum128.SCALE)
        for n in range(iterations):
            ...
            elif result_value.value >= term.value:
        ...
        result = result_value
        CertifiedMath._log_operation('sin', {'a': a, 'iterations': BigNum128.from_int(iterations)}, result, log_list, pqc_cid, quantum_metadata)
        return result

    @staticmethod
    def _safe_cos(a: BigNum128, iterations: int, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        """
...
=======
        x_bn = BigNum128(x_reduced)
        result_value = BigNum128(BigNum128.SCALE)
        x_power = CertifiedMath._safe_mul(x_bn, x_bn, log_list, pqc_cid, quantum_metadata)
        factorial = BigNum128(2 * BigNum128.SCALE)
        for n in range(iterations):
            term = CertifiedMath._safe_div(x_power, factorial, log_list, pqc_cid, quantum_metadata)
            if n % 2 == 0:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
...
=======
            ...
            if n < iterations - 1:
                ...
                factorial = CertifiedMath._safe_mul(factorial, factor2, log_list, pqc_cid, quantum_metadata)
        result = result_value
        CertifiedMath._log_operation('cos', {'a': a, 'iterations': BigNum128.from_int(iterations)}, result, log_list, pqc_cid, quantum_metadata)
        return result

    @staticmethod
    def _safe_tanh(a: BigNum128, iterations: int, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        """
...
=======
        ...
        if a.value == 0:
            result = BigNum128(0)
            CertifiedMath._log_operation('tanh', {'a': a, 'iterations': BigNum128.from_int(iterations)}, result, log_list, pqc_cid, quantum_metadata)
            return result
    ...
    @staticmethod
    def _safe_erf(a: BigNum128, iterations: int, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        """
...
=======
        ...
        if a.value == 0:
            result = BigNum128(0)
            CertifiedMath._log_operation('erf', {'a': a, 'iterations': BigNum128.from_int(iterations)}, result, log_list, pqc_cid, quantum_metadata)
            return result
        TWO_OVER_SQRT_PI = BigNum128(1128379167095512574)
        result_value = BigNum128(0)
        x_power = BigNum128(a.value)
        factorial = BigNum128(BigNum128.SCALE)
        sign = 1
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        for n in range(iterations):
...
=======
    ...
    @staticmethod
    def _safe_sigmoid(a: BigNum128, iterations: int, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        """
...
=======
            raise ValueError(f'Iterations must be between 0 and {CertifiedMath.MAX_EXP_ITERATIONS}')
        if a.value == 0:
            result = BigNum128(500000000000000000)
            CertifiedMath._log_operation('sigmoid', {'a': a, 'iterations': BigNum128.from_int(iterations)}, result, log_list, pqc_cid, quantum_metadata)
            return result
        exp_x = CertifiedMath._safe_exp(a, iterations, log_list, pqc_cid, quantum_metadata)
        one = BigNum128(BigNum128.SCALE)
    ...
    @staticmethod
    def _safe_softplus(a: BigNum128, iterations: int, log_list: List[Dict[str, Any]], pqc_cid: Optional[str]=None, quantum_metadata: Optional[Dict[str, Any]]=None) -> BigNum128:
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
        """
...
>>>>>>> b27f784 (fix(ci/structure): structural cleanup and genesis_ledger AST fixes)
    ...
    def verify_genesis_state(genesis_state: dict) -> dict:
        ...
        """
        try:
            required_keys = ['metadata', 'token_allocations', 'system_constants', 'governance', 'topology']
            for key in required_keys:
                if key not in genesis_state:
                    return {'valid': False, 'details': {'error': f'Missing required key: {key}'}}
            token_allocations = genesis_state.get('token_allocations', {})
            if 'shards' not in token_allocations:
                return {'valid': False, 'details': {'error': 'Missing shards in token allocations'}}
            ...
            for const in required_constants:
                if const not in system_constants:
                    return {'valid': False, 'details': {'error': f'Missing required system constant: {const}'}}
            governance = genesis_state.get('governance', {})
            if 'founding_nodes' not in governance:
                return {'valid': False, 'details': {'error': 'Missing founding_nodes in governance'}}
            topology = genesis_state.get('topology', {})
            if 'shard_connections' not in topology:
                return {'valid': False, 'details': {'error': 'Missing shard_connections in topology'}}
            return {'valid': True, 'details': {'message': 'Genesis state validation successful'}}
        except Exception as e:
            return {'valid': False, 'details': {'error': f'Validation exception: {str(e)}'}}
