...
class SafetyGuard:
    ...
    def validate_content(
        ...
        # Handle None content by treating it as empty string
        if content_text is None:
            content_text = ""
            
        # Initialize risk score (0.0 = no risk, 1.0 = maximum risk)
        ...
        # Check content length (very short content might be spam)
        ...
        # Determine if content passes based on risk threshold
        # Threshold is 0.5 - content with risk score > 0.5 is flagged
        ...
        # Log the operation
        log_entry = {
            "operation": "safety_guard_validation",
            "content_length": len(content_text),
            "explicit_found": found_explicit,
            "spam_indicators_found": spam_count,
            "risk_score": risk_score.to_decimal_string(),
            "passed": passed,
        ...
        return SafetyValidationResult(
            ...
            policy_version="SAFETY_GUARD_V1"
        )
    ...
    def validate_media(
        ...
        if "size" in media_metadata:
            size_mb = media_metadata["size"] / (1024 * 1024)  # Convert to MB
        ...
        # Log the operation
        log_entry = {
            "operation": "safety_guard_media_validation",
...
def test_safety_guard():
    ...
    media_metadata = {
        ...
        "hash": "QmHash1234567890"
    }
    
    result3 = safety_guard.validate_media(
        media_metadata=media_metadata,
        token_bundle=token_bundle,
        log_list=log_list,
        pqc_cid="test_safety_003",
