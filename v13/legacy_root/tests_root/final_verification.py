...
def test_error_handling():
    ...
    with CertifiedMath.LogContext() as log:
        # Test ln with zero value (should raise ValueError)
        try:
        ...
        # Test sqrt with negative-like value (testing domain check)
        # Since BigNum128 is unsigned, we can't directly test negative values
