...
def test_build_wallet_summary_view_deterministic() -> None:
    payload = {'balance': 10, 'locked': 2, 'total': 12}
...
def test_build_transaction_list_view_pure_mapping() -> None:
    txs = [{'tx_id': 'tx1', 'sender': 'a', 'receiver': 'b', 'amount': 1, 'asset': 'QFS', 'timestamp': '2025-01-01T00:00:00Z', 'status': 'pending'}, {'tx_id': 'tx2', 'sender': 'b', 'receiver': 'a', 'amount': 2, 'asset': 'QFS', 'timestamp': '2025-01-01T00:00:01Z', 'status': 'confirmed'}]
