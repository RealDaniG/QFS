...
from value_graph_ref import ValueGraphRef
if str(_THIS_FILE.parent) not in sys.path:
    sys.path.insert(0, str(_THIS_FILE.parent))
from test_value_node_replay import simple_user_state, simple_event_trace, run_event_sequence
...
def test_value_graph_consistent_with_userstate(simple_user_state, simple_event_trace: List[Dict[str, Any]]) -> None:
    ...
    """
    from test_value_node_replay import UserState
...
def test_value_graph_multiple_users_and_contents() -> None:
    ...
    events: List[Dict[str, Any]] = [{'type': 'ContentCreated', 'block': 1, 'user_id': 'user_a', 'content_id': 'c1'}, {'type': 'ContentCreated', 'block': 2, 'user_id': 'user_b', 'content_id': 'c2'}, {'type': 'InteractionCreated', 'block': 3, 'user_id': 'user_b', 'content_id': 'c1', 'interaction_type': 'like'}, {'type': 'InteractionCreated', 'block': 4, 'user_id': 'user_a', 'content_id': 'c2', 'interaction_type': 'comment'}, {'type': 'RewardAllocated', 'block': 5, 'user_id': 'user_a', 'token': 'ATR', 'amount': 7, 'content_id': 'c1'}, {'type': 'RewardAllocated', 'block': 6, 'user_id': 'user_b', 'token': 'ATR', 'amount': 3, 'content_id': 'c2'}]
...
def test_value_graph_mixed_atr_flx_rewards_atr_only() -> None:
    ...
    events: List[Dict[str, Any]] = [{'type': 'ContentCreated', 'block': 1, 'user_id': 'user_a', 'content_id': 'c1'}, {'type': 'RewardAllocated', 'block': 2, 'user_id': 'user_a', 'token': 'ATR', 'amount': 10}, {'type': 'RewardAllocated', 'block': 3, 'user_id': 'user_a', 'token': 'FLX', 'amount': 999}, {'type': 'RewardAllocated', 'block': 4, 'user_id': 'user_a', 'token': 'ATR', 'amount': 5}]
    g = ValueGraphRef().build_from_events(events)
...
def test_value_graph_governance_edges_and_votes() -> None:
    ...
    events: List[Dict[str, Any]] = [{'type': 'GovernanceVoteCast', 'block': 1, 'user_id': 'user_a', 'proposal_id': 'p1', 'vote_type': 'yes'}, {'type': 'GovernanceVoteCast', 'block': 2, 'user_id': 'user_a', 'proposal_id': 'p2', 'vote_type': 'no'}, {'type': 'GovernanceVoteCast', 'block': 3, 'user_id': 'user_b', 'proposal_id': 'p1', 'vote_type': 'abstain'}, {'type': 'GovernanceVoteCast', 'block': 4, 'user_id': 'user_b', 'proposal_id': 'p3', 'vote_type': 'yes'}, {'type': 'GovernanceVoteCast', 'block': 5, 'user_id': 'user_b', 'proposal_id': 'p3', 'vote_type': 'yes'}]
    g = ValueGraphRef().build_from_events(events)
...
def test_value_graph_long_trace_stays_deterministic() -> None:
    ...
    events: List[Dict[str, Any]] = [{'type': 'ContentCreated', 'block': 1, 'user_id': 'alice', 'content_id': 'cA'}, {'type': 'ContentCreated', 'block': 2, 'user_id': 'bob', 'content_id': 'cB'}, {'type': 'ContentCreated', 'block': 3, 'user_id': 'alice', 'content_id': 'cC'}, {'type': 'InteractionCreated', 'block': 4, 'user_id': 'bob', 'content_id': 'cA', 'interaction_type': 'like'}, {'type': 'InteractionCreated', 'block': 5, 'user_id': 'alice', 'content_id': 'cB', 'interaction_type': 'comment'}, {'type': 'InteractionCreated', 'block': 6, 'user_id': 'carol', 'content_id': 'cA', 'interaction_type': 'share'}, {'type': 'InteractionCreated', 'block': 7, 'user_id': 'carol', 'content_id': 'cC', 'interaction_type': 'like'}, {'type': 'RewardAllocated', 'block': 8, 'user_id': 'alice', 'token': 'ATR', 'amount': 10, 'content_id': 'cA'}, {'type': 'RewardAllocated', 'block': 9, 'user_id': 'alice', 'token': 'FLX', 'amount': 999, 'content_id': 'cA'}, {'type': 'RewardAllocated', 'block': 10, 'user_id': 'bob', 'token': 'ATR', 'amount': 3, 'content_id': 'cB'}, {'type': 'RewardAllocated', 'block': 11, 'user_id': 'carol', 'token': 'ATR', 'amount': 1, 'content_id': 'cA'}, {'type': 'RewardAllocated', 'block': 12, 'user_id': 'carol', 'token': 'FLX', 'amount': 50, 'content_id': 'cC'}, {'type': 'GovernanceVoteCast', 'block': 13, 'user_id': 'alice', 'proposal_id': 'p1', 'vote_type': 'yes'}, {'type': 'GovernanceVoteCast', 'block': 14, 'user_id': 'bob', 'proposal_id': 'p1', 'vote_type': 'no'}, {'type': 'GovernanceVoteCast', 'block': 15, 'user_id': 'carol', 'proposal_id': 'p2', 'vote_type': 'yes'}]
