...
async def get_my_rewards(authorization: Optional[str] = Header(None)):
    ...
    # Need session_manager, imported in dependencies?
    # Actually dependencies imports session_manager.
    # But route function needs to access it.
    # We can use dependency injection or import it.
    from v13.atlas.backend.lib.dependencies import session_manager
