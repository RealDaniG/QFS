...
class ExplainerEngine:
    ...
    def _register_default_resolvers(self):
        ...
        from v13.services.explainer.resolvers import (
            RewardResolver,
            CoherenceResolver,
            FlagResolver,
        )
    ...
    def explain(
        self, entity_type: str, entity_id: str, ledger_events: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
        """
        ...
        # Resolve inputs and computation
        explanation_data = resolver.resolve(
            entity_id, ledger_events, self.policy_version
        )
        ...
        proof_input = json.dumps(
            {
                ...
                "computation": explanation_data.get("computation", {}),
        ...
        explanation = {
            ...
            "generated_at": "2025-01-01T00:00:00Z",  # Mock timestamp
        }
