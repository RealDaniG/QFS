...
class TourRegistry:
    ...
    def _load_default_tours(self):
        ...
        welcome_tour = {
            ...
            "description": "Learn the basics of the QFS platform",
            "steps": [
                {
                    "id": "step_1",
                ...
                {
                    "id": "step_3",
                    "title": "Explore Explain-This",
                    "description": "Request an explanation for a decision",
                    "task_type": "USE_EXPLAIN_THIS",
                    "reward": 15,
                },
            ],
        }
    ...
    def list_tours(self) -> List[Dict[str, Any]]:
        return [
            {"id": t["tour_id"], "name": t["name"], "steps": len(t["steps"])}
            for t in self._tours.values()
        ]
