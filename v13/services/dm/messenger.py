...
class MessageSignal:
    ...
    def __init__(self, sender: str, recipient: str, storage_uri: str, content_hash: str, timestamp: int):
        self.sender = sender
...
class DirectMessagingService:
    ...
    def send_message_signal(self, sender_id: str, recipient_id: str, storage_uri: str, content_hash: str) -> bool:
        """
        ...
        signal = MessageSignal(sender=sender_id, recipient=recipient_id, storage_uri=storage_uri, content_hash=content_hash, timestamp=0)
