...
class NotificationService:
    ...
    def get_notifications(self, category: Optional[NotificationCategory] = None, 
    ...
    def _generate_notification_content(self, ledger_entry: LedgerEntry, 
                                    category: NotificationCategory) -> tuple[str, str]:
        """
        ...
        if category == NotificationCategory.SOCIAL:
            ...
            if entry_type == "hsmf_metrics":
                if is_safety_alert:
                    ...
                    return (
                        "Governance Update",
                        "System governance metrics updated."
                    )
