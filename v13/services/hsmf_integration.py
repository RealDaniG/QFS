...
def test_hsmf_integration():
    ...
    print(f"Proof entries: {len(proof_entries)}")

    assert result.is_valid, "Basic action should be valid"
    assert len(proof_entries) == 1, "One proof should be emitted"
    print("Integration test PASSED")


if __name__ == "__main__":
    test_hsmf_integration()
