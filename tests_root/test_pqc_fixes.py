...
try:
    ...
    def test_log_context_chain_integrity():
        ...
        with PQC.LogContext() as log:
            # Perform a simple operation to create log entries
            try:
                # This will fail because we don't have the real PQC library
            ...
            # Even without real operations, we can check the structure
            # Add a mock entry to test chain integrity
            log.append({
                "log_index": 0,
                "operation": "test",
                "details": {"test": "data"},
