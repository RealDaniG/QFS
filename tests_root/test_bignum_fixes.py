...
# Add the src directory to the path so we can import BigNum128
...
def test_bignum_to_decimal_string():
    ...
    try:
        ...
        # Test case 2: Small positive number with trailing zeros
        bn2 = BigNum128(1000000000000000000)  # This should be 1.0
        ...
        bn4 = BigNum128(1234567890123456789012345)  # 1234567.890123456789012345
        result4 = bn4.to_decimal_string()
        print(f"BigNum128(1234567890123456789012345) -> {result4}")
        # Should be "1234567.890123456789012345"
