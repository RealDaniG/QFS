...
from src.libs.pqc.PQC_Logger import PQC_Logger
from src.libs.pqc.PQC_Audit import PQC_Audit
...
class TestCanonicalSerializer:
    ...
    def test_list_canonicalization(self):
        ...
        # List order preserved, elements canonicalized
...
class TestPQCLogger:
    ...
    def test_context_reuse_prevention(self):
        ...
        # Attempting to reuse should raise
...
class TestZeroSimulationEnforcement:
    ...
    def test_no_nondeterministic_fields(self):
        ...
        # "time." would only appear in error messages, not as a field
